...
1. **Travailler uniquement dans ce workspace** (`/home/evan/niceassosport`). Éviter de créer, lire ou modifier des fichiers en dehors de ce dossier. En particulier, **éviter `/tmp`** et tout autre répertoire système extérieur au workspace — privilégier une alternative dans le workspace sauf si c'est strictement nécessaire.
